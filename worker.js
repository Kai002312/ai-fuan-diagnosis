...
//
// dwell3 / dwell10 = 画面が見えている状態で通算3秒/10秒とどまった。
//   広告流入の「開始率が極端に低い」が、【そもそも見ていない(誤タップ)】のか
//   【見た上で断った】のかを分けるために足した。この2つで取るべき手が正反対になる。
//     dwell3 ≒ visit  → 人は見ている。オファーが弱い
//     dwell3 << visit → 誤タップ。ページを直しても意味がなく、媒体の問題
//   バックグラウンドの時間は数えない(タブを放置しただけで「読んだ」ことにしない)。
const TRACK_STEPS = ["visit", "start", "q1", "read", "dwell3", "dwell10"];
